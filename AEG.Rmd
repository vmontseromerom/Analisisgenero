...
El objetivo del presente trabajo es realizar un análisis exploratorio con perspectiva de género utilizando información de la Encuesta Nacional de Ocupación y Empleo (ENOE), elaborada y publicada por el INEGI, para los años 2013 y 2018. Se considerara trabajar también con datos para el año 2021 para lograr observar sí existió alguna modificación en el comportamiento en las variables a analizar derivado del confinamiento por el virus Covid-19. El documento que se tomará como base principal para explorar la ENOE en el presente software R sera [@Escoto2021] 
...
Para lograr apreciar mejor esta información podemos analizarlo a traves de graficos.
...
Al observar los resultados es posible es notable que las actividades del sector primaro son realizadas mayoritariamente por los hombres, mientras que en el sector servicios se logra identificar que no solamente tienen un porcentaje elevado de poblaciín trabajadora, tanto hombres como mujeres, sin embargo es notable que hay una mayor presencia de mujeres. Como primer idea al realizar estas proporciones se puede plantear de idea que las mujeres estan integradas a actividades que representan menor trabajo fisico en comparación a las actividades en las cuales hay mas hombres empleados.

Desagregaremos un nivel mas y observaremos esta misma clasificación pero con la variable SCIAN , esta representa la clasificación de actividades segun el sistema de clasificación de
